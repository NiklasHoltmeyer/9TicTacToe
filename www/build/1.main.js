...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game__ = __webpack_require__(661);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_game_service_game_service__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_gamestatus_gamestatus__ = __webpack_require__(92);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GamePage = (function () {
    function GamePage(navCtrl, navParams, gameService, gameStatus, auth, zone, db, profile, modal) {
        ...
        this.index2 = [0, 1, 2];
        this.speedUpMessage = { message: 'Write !speedup to Start a Speedup Voting.',
            name: '9TicTacToe',
            color: 'black' };
        this.chat = [this.speedUpMessage];
        this.timeLeft = 30;
        gameStatus.resett();
    ...
    GamePage.prototype.initPictures = function () {
        var _this = this;
        var _loop_1 = function (i) {
            var uid = this_1.gameStatus.players[i].uid;
            this_1.profile.getProfilePicture(uid).then(function (url) {
                if (i == 0)
                    _this.profilePic0 = url;
                if (i == 1)
                    _this.profilePic1 = url;
            })
                .catch(function (err) { alert('initPictures Error'); alert(err); });
        };
        var this_1 = this;
        for (var i = 0; i < 2; ++i) {
            _loop_1(i);
    ...
    GamePage.prototype.sendMessage = function (event) {
        ...
        if (event.keyCode == enter && this.newMessage) {
            var regex = new RegExp('(.*)!speedup(.*)'); // einfacher vergleich wollte nicht
            if (regex.test(this.newMessage)) {
                ...
                var messageInfos = { name: this.auth.getdisplayName(), message: this.newMessage, color: (this.gameStatus.symbol) ? 'blue' : 'red' };
                var key = this.gameStatus.key;
    ...
    GamePage.prototype.getPicture = function (player) {
    ...
    GamePage.prototype.displayProfile = function (playerIndex) {
...
GamePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_5__providers_game_service_game_service__["a" /* GameServiceProvider */],
        __WEBPACK_IMPORTED_MODULE_6__providers_gamestatus_gamestatus__["a" /* GamestatusProvider */],
